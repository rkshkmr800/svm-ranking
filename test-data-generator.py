...
training_relevance_file = "pa3.rel.dev" #present in data folder
training_data_file = "pa3.signal.dev" #present in data folder
new_training_data_file = "test_data" #present in data folder
...
for record in train_data_scaled:
	...
	if(query_result_count[k]==j):
		new_training_data.write("query : "+query_list[k]+"###\n")
		k += 1
		j = 0
	i += 1
